...
print('Hello, I am Herbert the chatbot!')
...
print('Southern trees bear strange fruit,\n(Blood on the leaves and blood at the root)\nBlack body swinging in the southern breeze,\nStrange fruit hanging from the poplar trees.')
...
print('A decent approximation for the infinite decimal PI is {}'.format(pi))
...
total_houses_oprah_gave_me = new_houses_oprah_gave_me + 11
...
print('Oprah loves me so much she gave me {} houses!'.format(total_houses_oprah_gave_me))
